...
def main():
    ...
    alignment.add_argument("--minimap_preset",
                         dest="minimap_preset",
    ...
    posterior.add_argument("--threshold",
    ...
    posterior.add_argument("--both-strands",
    ...
    posterior.add_argument("--filter-all",
                          dest="keep_all",
